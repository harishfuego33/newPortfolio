                    ...
                    <div className="links">
                        ...
                        <div className="link-grid">
                            <div className="link-container">
                                ...
                                <img src="./assets/icon/icons8-linked-in.svg" alt="linked" className="link-icon"/>
                                    in/harish_33</a>
                            </div>
                            <div className="link-container">
                                <a className="link" href="https://github.com/harishfuego33" target="_blank" rel="noopener noreferrer">
                                <img src="./assets/icon/icons8-github.svg" alt="linked"className="link-icon" />
                                    github/harish_33</a>
                            </div>
                            <div className="link-container">
                                <a className="link" href="https://www.leetcode.com/harish_33" target="_blank" rel="noopener noreferrer">
                                <img src="../assets/icon/leetcode.svg" alt="linked" className="link-icon"/>
                            ...
                            <div className="link-container">
                                ...
                                <img src="../assets/icon/icons8-geeksforgeeks.svg" alt="linked" className="link-icon"/>
                                    geeksforgeeks/harish_33</a>
                            </div>
                            <div className="link-container">
                                <a className="link" href="https://www.hackerrank.com/harish_33" target="_blank" rel="noopener noreferrer">
                                <img src="../assets/icon/icons8-hackerrank.svg" alt="linked" className="link-icon"/>
