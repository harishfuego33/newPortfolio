...
const Start = () => {
  ...
  useEffect(() => {
    if (isLoaded) {
      const timers = [
        setInterval(() => setText1(true), 500),
        setInterval(() => setText2(true), 1000),
        setInterval(() => setText3(true), 1500),
        setInterval(() => setText4(true), 2000),
      ];
  ...
  if (isLoaded === false) setTimeout(() => setIsLoaded(true), 1000);
  return (
    <section className="flex justify-center Start__section" id="Start">
        ...
        <div className="intro__article col-7">
          ...
          <div
            className={`block-reveal ${
              text3 === true ? "block-reveal--active  " : ""
            }`}
          >
            <span
          ...
          <div
            className={`block-reveal ${
              text4 === true ? "block-reveal--active " : ""
            }`}
          >
            <span
              className="block-reveal__block "
