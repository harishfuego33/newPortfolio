...
const imgList = [
  "./assets/imageGallery/project-3/img-1.webp",
  "./assets/imageGallery/project-3/img-2.webp",
  "./assets/imageGallery/project-3/img-3.webp",
  "./assets/imageGallery/project-3/img-4.webp",
  "./assets/imageGallery/project-3/img-5.webp",
];
const projectInfo = {
